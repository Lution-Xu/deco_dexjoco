...
from dataset import libero_Dataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='/home/sunyu/xukun/IL_training_codebase/config/deco_univtac_80m.yaml', help='Path to configuration YAML file')
    parser.add_argument('--data', type=str, default='/root/data_local/univtac_converted/data', help='Path to dataset directory')
    ...
    parser.add_argument('--logs', type=str, default='/home/sunyu/xukun/IL_training_codebase/logs/deco80m_univtac', help='Directory to save logs and models')
    parser.add_argument('--save_period', type=int, default=60, help='Number of epochs between model checkpoints')
